...
### Demo()
Al ejecutar se empieza con una funcion llamada demo que carga un par de mecanicos clientes incidencias y coches  si no se desea con comentarla en main bastaria, se ha usado para hacelerar el proceso de pruebas
